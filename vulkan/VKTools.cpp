...
mkString VkResultToString(VkResult type)
{
	...
	default: { LOGE("Unknown Type"); return "Unknown Type"; }
	}
}
...
mkString VkMemoryHeapFlagsToString(VkMemoryHeapFlags flags)
{
	...
	if (flags & VK_MEMORY_HEAP_MULTI_INSTANCE_BIT)
		result += "VK_MEMORY_HEAP_MULTI_INSTANCE_BIT|";
	if (flags & VK_MEMORY_HEAP_MULTI_INSTANCE_BIT_KHR)
		result += "VK_MEMORY_HEAP_MULTI_INSTANCE_BIT_KHR|";
	if (result != "")
		result.pop_back();
	return result;
}
...
mkString VkMemoryPropertyFlagsToString(VkMemoryPropertyFlags flags)
{
	...
	if (flags & VK_MEMORY_PROPERTY_DEVICE_COHERENT_BIT_AMD)
		result += "VK_MEMORY_PROPERTY_DEVICE_COHERENT_BIT_AMD|";
	if (flags & VK_MEMORY_PROPERTY_DEVICE_UNCACHED_BIT_AMD)
		result += "VK_MEMORY_PROPERTY_DEVICE_UNCACHED_BIT_AMD|";
	if (result != "")
		result.pop_back();
	return result;
}
...
mkString VkImageUsageFlagsToString(VkImageUsageFlags flags)
{
	...
	if (flags & VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV)
		result += "VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV|";
